...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-popover p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 border border-border",
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("font-hud text-lg font-semibold tracking-wide", className)}
    {...props}
  />
));
